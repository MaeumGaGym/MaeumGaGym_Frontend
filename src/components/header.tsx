    ...
    <header className="flex w-auto h-[60px] items-center justify-between px-[170px] bg-white">
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center gap-3">
          <Button kind="white" fontSize="small">자기관리</Button>
          <Button kind="white" fontSize="small">운동자세</Button>
          <Button kind="white" fontSize="small">피클</Button>
          <Button kind="white" fontSize="small">마켓</Button>
        </div>
      </div>
      <div className="flex items-center gap-3">
