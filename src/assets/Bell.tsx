...
export const Bell = ({
  ...
  return (
    ...
    >
      ...
      <path d="M9.66667 18.8571C9.66667 18.8571 9.66667 20 12 20C14.3333 20 14.3333 18.8571 14.3333 18.8571H9.66667Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round" />
    </svg>
  )
}