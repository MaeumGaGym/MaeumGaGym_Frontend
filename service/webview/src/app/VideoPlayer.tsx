...
const VideoPlayer = memo(
  forwardRef<HTMLDivElement, PropsType>(({ src, videoId, isPlay, setIsModalOpen }: PropsType, ref) => {
    ...
    useEffect(() => {
      isPlay && videoRef.current?.play() && setPause(false)
      !isPlay && videoRef.current?.pause() && setPause(true)
    }, [isPlay])

    useEffect(() => {
      setIsModalOpen(nowModalOpen ? true : false)
    }, [nowModalOpen])
